...
//	public static void brute (ArrayList<Integer> ciphertext ) throws Exception {
//		File file = new File("C:\\Users\\ahmed\\eclipse-workspace\\q2\\src\\application\\Lab2_shiftcipher\\src\\bruteforce.txt");
//		try (PrintWriter writer = new PrintWriter(file);) {
//			for (int x =0 ; x<26;x++) {
//	            StringBuilder s = new StringBuilder();
//			for (int i=0;i<ciphertext.size();i++) {
//			int charvalue =  mymod(ciphertext.get(i)-x,26)+97;
//			 String s1 = String.valueOf((char)charvalue);
//             s.append(s1);
//			}
//			writer.println("key:"+x+":"+s.toString());
//			String y =isReadable(s.toString(),x);
